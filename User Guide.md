...
## Simulation Mode
### GT League
The most important events are hosted there. Win all championships available there to win the game.
### Spot Race
Beginner friendly races that are available from the start.
### Special Events
...
# Options
## Trophy Hunt
Adds Trophies to the item pool. Makes the goal additionally require collecting a specified amount of trophies.
## Trophy Total
